...
root=tk.Tk()
root.title("graph")
# tk.Label(root, text="TYPE THE NAME OF THE CURVE:").pack(pady=5)
# en = tk.Entry(root)
# en.pack(pady=5, padx=10)
# en2= tk.Entry(root)
# en2.pack(pady=5, padx=10)

tk.Button(root, text="parabola", command=parabola).pack(pady=5)
label = tk.Label(root, text="")
label.pack(pady=5)
tk.Button(root, text="parabola", command=hyperbola).pack(pady=5)
label = tk.Label(root, text="")
label.pack(pady=5)
tk.Button(root, text="parabola", command=circle).pack(pady=5)
label = tk.Label(root, text="")
label.pack(pady=5)
tk.Button(root, text="parabola", command=ellipse).pack(pady=5)
label = tk.Label(root, text="")
label.pack(pady=5)
# tk.Button(root, text="parabola", command=t).pack(pady=5)
# label = tk.Label(root, text="")
# label.pack(pady=5)
# tk.Button(root, text="parabola", command=parabola).pack(pady=5)
# label = tk.Label(root, text="")
